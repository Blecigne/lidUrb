...
#' las = LW_segmentation_dbscan_jak(las)
#'
...
LW_segmentation_dbscan_jak = function(las,search_radius = 0.05, dbscan_eps = 0.03, min_cluster_size = 10L, reclass_trunk_th = 0.5){
